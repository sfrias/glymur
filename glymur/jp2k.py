...
class Jp2k(Jp2kBox):
    ...
    def _read(self, **kwargs):
        ...
        """
        if re.match("0|1.[01234]|2.2", version.openjpeg_version):
            msg = ("You must have a version of OpenJPEG between 1.5.0 and "
                   "2.1.2 installed before you can read JPEG2000 images with "
