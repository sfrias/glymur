...
class TestReadArea(unittest.TestCase):
    ...
    def test_NR_DEC_p1_04_j2k_44_decode(self):
        actual = self.j2k[640:768, 352:480]
        expected = self.j2k_data[640:768, 352:480]
        np.testing.assert_array_equal(actual, expected)
    ...
    def test_NR_DEC_p1_04_j2k_51_decode(self):
        actual = self.j2k[640:768:4, 352:480:4]
        expected = self.j2k_quarter_data[160:192, 88:120]
        np.testing.assert_array_equal(actual, expected)

    def test_NR_DEC_p1_04_j2k_52_decode(self):
        actual = self.j2k[672:800:4, 352:480:4]
        expected = self.j2k_quarter_data[168:200, 88:120]
        np.testing.assert_array_equal(actual, expected)
